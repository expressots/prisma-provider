...
export type MySQLAttrType = TypesAttributeMySQL | BooleanAttrMySQL | IntAttrMySQL | BigIntAttrMySQL | FloatAttrMySQL | DecimalAttrMySQL | DateTimeAttrMySQL | JsonAttrMySQL | BytesAttrMySQL;
export const MySQLAttr = { ...TypesAttributeMySQL, ...BooleanAttrMySQL, ...IntAttrMySQL, ...BigIntAttrMySQL, ...FloatAttrMySQL, ...DecimalAttrMySQL, ...DateTimeAttrMySQL, ...JsonAttrMySQL, ...BytesAttrMySQL };